  ...
  return (
    <>
      <TextExpander>
        ...
        men who are so beguiled and demoralized by the charms of r the
      ...
      >
        ...
        avoided. But in certain circumstances and owing to the claims of duty o
      </TextExpander>
      <br></br>

      <TextExpander expanded={true} className="box">
        o odio dignissimos ducimus qui blanditiis praesentium voluptatum
  ...
  return (
    <>
      <div className={className}>
        {isexpanded ? children : "Work Work Work"}

        <button  onClick={() => setisexpanded((prev) => !prev)}>{isexpanded ? CollapseButtonText : expandButtonText}</button>
      </div>
    </>
  );
}
